...
export class HomeComponent implements OnInit, OnDestroy {
  ...
  private readonly editorialHeroImage: HeroImage = {
    src: 'hero-laverne-banner.webp',
    alt: 'Campagne LAVERNE',
    kind: 'editorial',
    position: '18% center',
    srcset: '/hero-laverne-banner-mobile.webp 900w, /hero-laverne-banner.webp 2089w',
