...
export class HomeComponent {
  ...
  promoBanners = [
    { tag: 'Collection Femme', title: 'Sense', sub: 'La collection signature de Georgina. Sens, élégance et féminité.', btn: 'Découvrir la collection', img: '/sense.webp', prodName: 'Sense', path: '/elle' },
    { tag: 'Bestseller N°1', title: 'Gentle', sub: 'Le parfum le plus demandé. Fraîcheur et élégance arabes.', btn: 'Commander maintenant', img: '/gentle.webp', prodName: 'Gentle', path: '/lui' }
  ];
